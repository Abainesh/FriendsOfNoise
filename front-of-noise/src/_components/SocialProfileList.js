...
/**
* Unlinks provider from current user account
*/
...
renderProfileList = ({ providerId, photoURL }) => {
    ...
    return (
      <div 
        className="container__profile" key={providerName}>
        <img
          src={photoURL}
          alt={providerName}
        ...
        <button
          ...
          onClick={e => this.handleProviderUnlink(e, providerName)}>Unlink</button>
      </div>
    );
  };
